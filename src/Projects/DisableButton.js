...
function DisableButton() {
  ...
  return (
    <div className='flex flex-col justify-center items-center pt-20 gap-10 w-screen'>
     <h3 className='font-bold text-[20px]'>Disable Button If Text Box is Empty.</h3>
     <div className=''>
     <input type="text" onChange={handleChange}
     className='bg-gray-50 border border-gray-300 w-[300px] text-gray-900 text-sm rounded-lg p-2.5 outline-none mr-6'/>
